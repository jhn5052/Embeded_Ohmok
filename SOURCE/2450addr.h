...
#define pISR_DMA		(*(unsigned *)(_ISR_STARTADDRESS+0x64))
#define pISR_UART3		(*(unsigned *)(_ISR_STARTADDRESS+0x68))
#define pISR_CFCON		(*(unsigned *)(_ISR_STARTADDRESS+0x6c))
#define pISR_SDI1		(*(unsigned *)(_ISR_STARTADDRESS+0x70))
#define pISR_SDI0		(*(unsigned *)(_ISR_STARTADDRESS+0x74))
#define pISR_SPI0		(*(unsigned *)(_ISR_STARTADDRESS+0x78))
#define pISR_UART1		(*(unsigned *)(_ISR_STARTADDRESS+0x7c))
#define pISR_NAND		(*(unsigned *)(_ISR_STARTADDRESS+0x80))
#define pISR_USBD		(*(unsigned *)(_ISR_STARTADDRESS+0x84))
#define pISR_USBH		(*(unsigned *)(_ISR_STARTADDRESS+0x88))
#define pISR_IIC0		(*(unsigned *)(_ISR_STARTADDRESS+0x8c))
...
#define pISR_INT2D   	(*(unsigned *)(_ISR_STARTADDRESS+0xA0))
#define pISR_INT_IIC1	(*(unsigned *)(_ISR_STARTADDRESS+0xA4))
//   #define reserved	(*(unsigned *)(_ISR_STARTADDRESS+0xA8))
//   #define reserved	(*(unsigned *)(_ISR_STARTADDRESS+0xAC))
#define pISR_INT_PCM0	(*(unsigned *)(_ISR_STARTADDRESS+0xB0))
#define pISR_INT_PCM1	(*(unsigned *)(_ISR_STARTADDRESS+0xB4))
#define pISR_INT_I2S0	(*(unsigned *)(_ISR_STARTADDRESS+0xB8))
#define pISR_INT_I2S1	(*(unsigned *)(_ISR_STARTADDRESS+0xBC))
...
// bit of group 2
#define BIT_INT_2D		(0x1<< 0)
#define BIT_IIC1		(0x1<< 1)
//#define RESERVED		(0x1<< 2)
//#define RESERVED		(0x1<< 3)
...
#define	BIT_SUBINT_DMA7		(0x1<<30)
#define	BIT_SUBINT_DMA6 	(0x1<<29)
#define	BIT_SUBINT_AC97 	(0x1<<28)
#define	BIT_SUBINT_WDT  	(0x1<<27)
#define	BIT_SUBINT_ERR3 	(0x1<<26)
#define	BIT_SUBINT_TXD3 	(0x1<<25)
#define	BIT_SUBINT_DMA5 	(0x1<<24)
#define	BIT_SUBINT_DMA4 	(0x1<<23)
#define	BIT_SUBINT_DMA3 	(0x1<<22)
#define	BIT_SUBINT_DMA2 	(0x1<<21)
#define	BIT_SUBINT_DMA1 	(0x1<<20)
#define	BIT_SUBINT_DMA0 	(0x1<<19)
#define	BIT_SUBINT_LCD4 	(0x1<<18)
#define	BIT_SUBINT_LCD3 	(0x1<<17)
#define	BIT_SUBINT_LCD2 	(0x1<<16)
//#define		reserved    (0x1<<15)
//#define		reserved    (0x1<<14)
#define	BIT_SUBINT_CAM_P	(0x1<<13)
#define	BIT_SUBINT_CAM_C	(0x1<<12)
#define	BIT_SUBINT_ADC  	(0x1<<11)
#define	BIT_SUBINT_TC   	(0x1<<10)
#define	BIT_SUBINT_ERR2 	(0x1<<09)
#define	BIT_SUBINT_TXD2 	(0x1<<08)
#define	BIT_SUBINT_RXD2 	(0x1<<07)
#define	BIT_SUBINT_ERR1 	(0x1<<06)
#define	BIT_SUBINT_TXD1 	(0x1<<05)
#define	BIT_SUBINT_RXD1 	(0x1<<04)
#define	BIT_SUBINT_ERR0 	(0x1<<03)
#define	BIT_SUBINT_TXD0 	(0x1<<02)
#define	BIT_SUBINT_RXD0 	(0x1<<01)


#ifdef __cplusplus
}
#endif
#endif//__2450ADDR_H__
